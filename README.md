...
You have to have npm and node installed for the project to work. (https://nodejs.org/en/download/)

run `npm install`

## You have to have firebase is installed

run `npm i firebase` 

## You may have to have react chart js 2 installed as well
